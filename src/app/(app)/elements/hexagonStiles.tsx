...
const geoJsonStyleClients= {
  ...
  const geoJsonStyleClientsProblems= {
    color: 'red',
    fillColor: '#E4080A',
    fillOpacity: 0.8,
    opacity: 1,
...
//Exporta estos elementos para ser usados en otros archivos
export {svgIcon,geoJsonStyleClients,geoJsonStyleClientsProblems}